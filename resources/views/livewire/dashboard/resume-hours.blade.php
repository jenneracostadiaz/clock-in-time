<div class="w-full flex flex-col items-center">
    @if($showingResumeHours)
        <div class="open-checkout relative w-[330px] h-[330px] [&>div]:hover:rotate-45 [&>div>div]:hover:rotate-90 [&>div>div>div]:hover:rotate-45 [&>div]:focus:-rotate-45 [&>div>div]:focus:-rotate-90 [&>div>div>div]:focus:-rotate-45">
            <div
                id="bg-bottom"
            ...
            <section class="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center text-white">
                <p class="text-3xl pt-2">Your resume</p>
                <hr>
                <p class="text-sm">Entrance: {{ $check_in }}</p>
                <p class="text-sm">Exit: {{ $check_out }}</p>
                <p class="text-xs">Thanks for your work today</p>
            </section>
        </div>
    @endif
